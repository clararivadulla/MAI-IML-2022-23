...
def main():
    ...
    # K-Means
    k_means = KMeans(k=3, max_iter=100, n_repeat=20, seed=12345)
    k_means.train(data)
    ...
    # K-Means
    k_means_pca = KMeans(k=3, max_iter=100, n_repeat=20, seed=12345)
    ...
    # K-Means
    k_means_sklearn_pca = KMeans(k=3, max_iter=100, n_repeat=20, seed=12345)
    ...
    scatter_plot(k_means_sklearn_pca_labels, principal_components_sklearn_pca, (0, 1), title='Iris dataset\nK-Means with 3 clusters\nusing PCA from sklearn')
    ...
    scatter_plot(agglomerative_clustering_sklearn_pca_labels, principal_components_sklearn_pca, title='Iris dataset\nAgglomerative Clustering with 3 clusters\nusing PCA from sklearn')
    ...
    # K-Means
    k_means_incremental_pca = KMeans(k=3, max_iter=100, n_repeat=20, seed=12345)
    ...
    scatter_plot(k_means_incremental_pca_labels, principal_components_incremental_pca, (0, 1), title='Iris dataset\nK-Means with 3 clusters\nusing Incremental PCA from sklearn')
    ...
    # K-Means
    k_means_f_agglo = KMeans(k=3, max_iter=100, n_repeat=20, seed=12345)
    ...
    # K-Means
    k_means_t_sne = KMeans(k=3, max_iter=100, n_repeat=20, seed=12345)
