...
def main():
    ...
    scatter_plot(k_means_sklearn_pca_labels, principal_components_sklearn_pca, (0, 1), title='Pima Diabetes dataset\nK-Means with 3 clusters\nusing PCA from sklearn')
    ...
    scatter_plot(agglomerative_clustering_sklearn_pca_labels, principal_components_sklearn_pca, title='Pima Diabetes dataset\nAgglomerative Clustering with 3 clusters\nusing PCA from sklearn')
    ...
    scatter_plot(k_means_incremental_pca_labels, principal_components_incremental_pca, (0, 1), title='Pima Diabetes dataset\nK-Means with 3 clusters\nusing Incremental PCA from sklearn')
