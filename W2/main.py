...
if __name__ == '__main__':
    ...
    run_clustering.run(data, labels, dataset_name="Vowel", k=11, num_features=[5,6,7,8], plot_3D=False)
    ...
    run_clustering.run(data, labels, dataset_name="Pima Diabetes", k=2, num_features=[2,3,4], plot_3D=False)
