...
def main():
    ...
    agglomerative_clustering = AgglomerativeClustering(n_clusters=3, affinity='manhattan', linkage='average').fit(data)
    ...
    print(
        '\n**************************************************\nMean Shift\n**************************************************')
    bandwidth_value = estimate_bandwidth(data, quantile=0.3)
    ...
    print(
        '\n**************************************************\nFuzzy C-Means\n**************************************************')
    fuzzy_c_means = FuzzyCMeans(n_clusters=3, m=2)
