...
if __name__ == '__main__':
    ...
    vowel_results_sorted_by_accuracy = reduction_techniques(data=vowel_data, dataset_name=dataset_name, k=1, distance_metric='minkowski', voting_scheme='majority', weighting_scheme='ridge', numeric_cols=numeric_cols, nominal_cols=nominal_cols)
    ...
    satimage_results_sorted_by_accuracy = reduction_techniques(data=sat_image_data, dataset_name=dataset_name, k=3, distance_metric='minkowski', voting_scheme='majority', weighting_scheme='uniform', numeric_cols=numeric_cols, nominal_cols=nominal_cols)
