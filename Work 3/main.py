...
if __name__ == '__main__':
    ...
    vowel_results_sorted_by_accuracy = test_performance(data=vowel_data, dataset_name=dataset_name, numeric_cols=numeric_cols, nominal_cols=nominal_cols, verbose=True)
    ...
    pen_based_results_sorted_by_accuracy = test_performance(data=pen_based_data, dataset_name=dataset_name, numeric_cols=numeric_cols, nominal_cols=nominal_cols, verbose=True)
    ...
    satimage_results_sorted_by_accuracy = test_performance(data=sat_image_data, dataset_name=dataset_name, numeric_cols=numeric_cols, nominal_cols=nominal_cols, verbose=True)
