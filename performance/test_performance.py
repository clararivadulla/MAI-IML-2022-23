...
from pre_processing import read_arff_files, iris_pre_processing, credit_a_pre_processing, pima_diabetes_pre_processing#, \
    #cmc_pre_processing, satimage_pre_processing, vehicle_pre_processing, segment_pre_processing, vowel_pre_processing
...
def test_performance(dataset_name):
    ...
    elif dataset_name == 'credit_a':
        df, meta = read_arff_files.read_arff_file('./../datasets/credit-a.arff')
        data, labels = credit_a_pre_processing.main(df, meta)
    ...
    for k in k_values:
        ...
        #                                              actual_labels=labels)
        # all_metrics['KHarmonicMeans'].append(fuzzy_c_means_metrics)
...
if __name__ == '__main__':
    test_performance(dataset_name='credit_a')
