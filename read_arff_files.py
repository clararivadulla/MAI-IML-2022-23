...
def read_arff_file(filename):
    arff_file = arff.loadarff(filename) # Load the arff file with the 'loadarff' function
    df = pd.DataFrame(arff_file[0]) # Create a dataframe 'df' containing the data of the arff file read
